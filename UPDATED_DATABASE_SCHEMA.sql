-- QuickFlips.ai - Updated Database Schema
-- Aligned with 8-Agent System and Pricing Tiers
...
CREATE TABLE public.messenger_interactions (
    id UUID DEFAULT uuid_generate_v4() PRIMARY KEY,
    user_id UUID REFERENCES public.profiles(id) ON DELETE CASCADE,
...
-- Enable Row Level Security (RLS) - FIXES SECURITY ISSUES
